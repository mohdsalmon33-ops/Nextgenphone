  ...
  return (
    <div className="min-h-screen relative selection:bg-violet-500/30">
      ...
      <main>
        ...
        {currentPage === 'refurbished' && <RefurbishedPage />}
        {currentPage === 'trade-in' && <TradeInPage />}
      </main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 opacity-70">
              <li><button onClick={() => setCurrentPage('home')} className="hover:text-violet-500 hover:underline">Shop All Phones</button></li>
              <li><button onClick={() => setCurrentPage('refurbished')} className="hover:text-violet-500 hover:underline">Refurbished</button></li>
              <li><button onClick={() => setCurrentPage('trade-in')} className="hover:text-violet-500 hover:underline">Trade-In Program</button></li>
              <li><button onClick={() => setCurrentPage('track-order')} className="hover:text-violet-500 hover:underline">Track Order</button></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 opacity-70">
              ...
              <li><button onClick={() => setCurrentPage('returns')} className="hover:text-violet-500 hover:underline">Return Policy</button></li>
            </ul>
          </div>
        </div>
